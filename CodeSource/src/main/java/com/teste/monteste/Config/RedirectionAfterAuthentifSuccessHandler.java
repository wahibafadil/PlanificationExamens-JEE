 ...
 *
 */
public class RedirectionAfterAuthentifSuccessHandler implements AuthenticationSuccessHandler {
	...
	public RedirectionAfterAuthentifSuccessHandler() {
		super();
	}
	...
	protected String determineTargetUrl(final Authentication authentication) {
		...
		roleTargetUrlMap.put("ADMIN", "/examens/all"); // hetti home page 
