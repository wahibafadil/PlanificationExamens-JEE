...
@Service
public class CustomAuthentifService implements UserDetailsService {

	@Autowired
	private CompteRepository userRepository; // le DAO qui gère les utilisateurs

	/** Utilisé pour la journalisation */
	Logger LOGGER = LoggerFactory.getLogger(getClass());

	public CustomAuthentifService() {
	}
